...
enum Tables {USERS, SETTINGS, PROJECTS, SECTIONS, FILES, TASKS} # Таблицы в базе данных
...
func connection_db(db_name: String) -> void:
	...
	_create_table(Tables.SETTINGS, ["color_preset BOOLEAN", "color_scheme INT", "color_1 VARCHAR(255)",
		"color_2 VARCHAR(255)", "color_3 VARCHAR(255)", "color_4 VARCHAR(255)", "dark_theme BOOLEAN",])
